...
public class csvLuongoReaderSetup {
	...
	public FlatFileItemReader < CatalogoCSV > csvCatalogoReader() {
	    FlatFileItemReader < CatalogoCSV > reader = new FlatFileItemReader < CatalogoCSV > ();
	...
	public JdbcBatchItemWriter<Catalogo> csvCatalogoWriter() {
		 JdbcBatchItemWriter<Catalogo> csvCatalogoWriter = new JdbcBatchItemWriter<Catalogo>();
		 csvCatalogoWriter.setItemSqlParameterSourceProvider(new BeanPropertyItemSqlParameterSourceProvider<Catalogo>());
